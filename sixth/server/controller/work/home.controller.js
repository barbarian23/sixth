...
const newNumber;
// newNumber = ["9","9","9","9","9","9"] >> duyet het, day la dieu kien dung
export function renderNumber(newNumber, checkOk) { // function sinh number
    // 
    if (newNumber[0] == 10) // newNumber = ["10","9","9","9","9","9"] >> duyet het, day la dieu kien dung
        return null; // khong render duoc nua
    else {
        if (checkOk) { 
            newNumber = backNewNumber(newNumber);
        }
    }
}
